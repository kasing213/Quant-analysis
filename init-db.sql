-- Initial Database Setup for Quantitative Trading System
...
BEGIN
    IF NOT EXISTS (SELECT FROM pg_catalog.pg_user WHERE usename = 'trader') THEN
        CREATE USER trader WITH PASSWORD 'trading_secure_password_2024';
    END IF;
END
$$;

-- Grant privileges to trader user
...
-- Create extension for UUID generation and other required extensions
...
-- Create schemas for organization and audit trails
...
GRANT ALL PRIVILEGES ON SCHEMA compliance TO trader;
GRANT ALL PRIVILEGES ON SCHEMA security TO trader;
GRANT ALL PRIVILEGES ON SCHEMA reporting TO trader;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA trading GRANT ALL PRIVILEGES ON TABLES TO trader;
ALTER DEFAULT PRIVILEGES IN SCHEMA trading GRANT ALL PRIVILEGES ON SEQUENCES TO trader;
ALTER DEFAULT PRIVILEGES IN SCHEMA audit GRANT ALL PRIVILEGES ON TABLES TO trader;
ALTER DEFAULT PRIVILEGES IN SCHEMA audit GRANT ALL PRIVILEGES ON SEQUENCES TO trader;
ALTER DEFAULT PRIVILEGES IN SCHEMA compliance GRANT ALL PRIVILEGES ON TABLES TO trader;
ALTER DEFAULT PRIVILEGES IN SCHEMA compliance GRANT ALL PRIVILEGES ON SEQUENCES TO trader;
ALTER DEFAULT PRIVILEGES IN SCHEMA security GRANT ALL PRIVILEGES ON TABLES TO trader;
ALTER DEFAULT PRIVILEGES IN SCHEMA security GRANT ALL PRIVILEGES ON SEQUENCES TO trader;
ALTER DEFAULT PRIVILEGES IN SCHEMA reporting GRANT ALL PRIVILEGES ON TABLES TO trader;
ALTER DEFAULT PRIVILEGES IN SCHEMA reporting GRANT ALL PRIVILEGES ON SEQUENCES TO trader;

-- Set search path to include all schemas
SET search_path TO trading, audit, compliance, security, reporting, public;
